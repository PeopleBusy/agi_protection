...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if ('' === $trimmedPathinfo) {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'agi_index');
            }

            return array (  '_controller' => 'AgiBundle\\Controller\\LoginController::loginAction',  '_route' => 'agi_index',);
        }

        // agi_login
        if ('/login' === $pathinfo) {
            return array (  '_controller' => 'AgiBundle\\Controller\\LoginController::loginAction',  '_route' => 'agi_login',);
        }

        // agi_logout
        if ('/logout' === $pathinfo) {
            return array (  '_controller' => 'AgiBundle\\Controller\\LoginController::logoutAction',  '_route' => 'agi_logout',);
        }
        ...
        if (0 === strpos($pathinfo, '/agent')) {
            ...
            if (0 === strpos($pathinfo, '/agent/d')) {
                ...
                // afficher_planning_agent
                if (0 === strpos($pathinfo, '/agent/display_planning') && preg_match('#^/agent/display_planning/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'afficher_planning_agent')), array (  '_controller' => 'AgiBundle\\Controller\\AgentController::displayPlanningAction',));
                }
            ...
            // planning_agent
            if (0 === strpos($pathinfo, '/agent/planning') && preg_match('#^/agent/planning/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'planning_agent')), array (  '_controller' => 'AgiBundle\\Controller\\AgentController::planningAction',));
            }

            // imprimer_planning_agent
            if (0 === strpos($pathinfo, '/agent/imprimer_planning') && preg_match('#^/agent/imprimer_planning/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'imprimer_planning_agent')), array (  '_controller' => 'AgiBundle\\Controller\\AgentController::imprimerAction',));
            }

            // agent_recapitulatif
            if (0 === strpos($pathinfo, '/agent/recapitulatif') && preg_match('#^/agent/recapitulatif/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'agent_recapitulatif')), array (  '_controller' => 'AgiBundle\\Controller\\AgentController::recapitulatifAction',));
            }
        ...
        elseif (0 === strpos($pathinfo, '/site')) {
            ...
            if (0 === strpos($pathinfo, '/site/d')) {
                ...
                // afficher_calendrier_site
                if (0 === strpos($pathinfo, '/site/display_calendrier') && preg_match('#^/site/display_calendrier/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'afficher_calendrier_site')), array (  '_controller' => 'AgiBundle\\Controller\\SiteController::displayCalendrierAction',));
                }
            ...
            // site_recapitulatif
            if (0 === strpos($pathinfo, '/site/recapitulatif') && preg_match('#^/site/recapitulatif/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'site_recapitulatif')), array (  '_controller' => 'AgiBundle\\Controller\\SiteController::recapitulatifAction',));
            }
